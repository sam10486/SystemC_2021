...
int main(int argc, char *argv[]){
    ...
    if (inFile2.fail()) {
       ...
       return 1;
        ...
        if(inFile2 >> datalength2){
            oFile << "inFile2 datalength2 = " << datalength2 << endl;
    ...
    if(List_string_assignment == List_string){
        cout << "List_string_assignment == List_string !" << endl << endl;
        oFile << "List_string_assignment == List_string !" << endl << endl;
    }else{
        cout << "List_string_assignment != List_string !" << endl << endl;
        oFile << "List_string_assignment != List_string !" << endl << endl;
    }
    ...
    List<double> List_test_overloading;

    oFile << "(add two of Lists using operator+)" << endl;
    oFile << "List_double = " << List_double;
    oFile << "List_double_copy = " << List_double_copy;
    List_test_overloading = List_double + List_double_copy;
    oFile << "Equation : List_test_overloading = List_double + List_double_copy = " << List_test_overloading;
    oFile << "//////////////////////////////////////////////////////" << endl;

    oFile << "(use operator++ to add 1 to another List)" << endl;//++a
    oFile << "List_doulbe =  " << List_double;
    oFile << "List_test_overloading = " << List_test_overloading;
    oFile << "Equation : List_double = ++List_test_overloading " << endl;
    List_double = ++List_test_overloading;
    oFile << "List_test_overloading = " << List_test_overloading;
    oFile << "List_double = " << List_double;
    oFile << "//////////////////////////////////////////////////////" << endl;
    ...
    oFile << "List_double = " << List_double;
    List_double += List_test_overloading;
    oFile << "Equation : List_double += List_test_overloading =  " << List_double;
    oFile << "//////////////////////////////////////////////////////" << endl;
